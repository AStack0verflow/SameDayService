...
$Work_before_10 = $_POST['Work_before_10'];
$desc_of_prob = $_POST['desc_of_prob'];
$data = "$recipients | $firstname  | $lastname | $building | $Work_before_10 | $desc_of_prob\n";
...
$TARGET_EMAIL = array(EMAIL_NAME."@humboldt\.edu$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","ew52@humboldt.edu");
...
$FROM_USER = "housing.humboldt.edu";                            // the default - setting not used
...
$CSVDIR = "/var/www/webaccounts/housing/public_html/sds/csv";                       // directory for csv files; 
...
$TEMPLATEDIR = "http://www.humboldt.edu/housing/sds/template";              // directory for email template files;
...
$NEXT_NUM_FILE = "/var/www/webaccounts/housing/public_html/sds/template/nextNum.txt";

            /* Help: http://www.tectite.com/fmdoc/put_data_in_url.php */
define("PUT_DATA_IN_URL",false); // set to true to place data in the URL
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_ABOUT_FORMMAIL] = 'Your form submission was sent to the '.
                                     '<a href="http://humboldt.edu/">Humboldt State Housing</a> '.
									 'Department. We will get back to you as soon as we can.';
